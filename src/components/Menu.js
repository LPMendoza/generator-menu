...
class Menu extends React.Component{
   ...
   render = () => {
      ...
      return (
         <React.Fragment>
            <div className="contCard contMenu col-md-12 mb-4 px-0 bg-white rounded shadow-sm ">
               <h3 className="my-4 mx-4">Menú</h3>
               <div className="table-responsive px-4 mb-2 pb-0">
               ...
               <div className="pl-4 pb-3">
                  <button onClick={handleGenerateMenu} className="btn btn-secondary shadow-sm my-2">Generar Menú <span className="fas fa-sync-alt ml-2"></span></button>
